...
namespace GeolocationCS
{
    public sealed partial class Scenario3 : Page
    {
        ...
        public Scenario3()
        {
            ...
            //string filePath = localFolder.Path.ToString() + @"\locationLogs.txt";
            ...
            if (sender != null)
            {
                ...
                await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
                {
                    try
                    {
                        ...
                        string msg = String.Format("Status: {0}", settings.Values["Status"].ToString());
                       // Log.Information(msg);
                        msg = String.Format("Latitude: {0}, Longitude: {1}, Accuracy: {2}", ScenarioOutput_Latitude.Text, ScenarioOutput_Longitude.Text, ScenarioOutput_Accuracy.Text);
                       // Log.Information(msg);
                    }
                    catch (Exception ex)
                    {
